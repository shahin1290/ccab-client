...
export const getQuizList = (bootcampId) => async (dispatch, getState) => {
  try {
    ...
    const response = await axios.get('https://server.ccab.tech/api/quizzes/' + bootcampId, config)
    dispatch({
...
export const getMyQuizList = () => async (dispatch, getState) => {
  try {
    ...
    const response = await axios.get(`https://server.ccab.tech/api/quizzes/myquizlist`, config)
...
export const quizDelete = (bootcampId, weekId, id) => async (
  ...
  try {
    ...
    await axios.delete(`https://server.ccab.tech/api/quizzes/${bootcampId}/${weekId}/${id}`, config)
...
export const updateQuiz = (bootcampId, weekId, id, quiz) => async (
  ...
  try {
    ...
    await axios.put(`https://server.ccab.tech/api/quizzes/${bootcampId}/${weekId}/${id}`, quiz, config)
