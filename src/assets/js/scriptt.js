;(function ($) {
    ...
    $('.time-countdown-two').each(function () {
      ...
      $this.countdown(finalDate, function (event) {
        var $this = $(this).html(
          event.strftime(
            '' +
              '<div className="counter-column"><span className="count">%M</span></div>  ' +
              '<div className="counter-column"><span className="count">%S</span></div>'
          )
        )
      })
    })
  ...
  if ($('.hidden-bar').length) {
    ...
    $('.hidden-bar .side-menu ul li.dropdown').append(
      '<div className="dropdown-btn"><span className="arrow_carrot-down"></span></div>'
    )
...
document.addEventListener('click', function (event) {
  ...
  if (
    ...
    !isClickInsideElement5 &&
    !isClickInsideElement1 &&
