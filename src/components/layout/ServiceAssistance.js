...
import image2 from "../../assets/images/services/file1.jpeg";
import image3 from "../../assets/images/services/fun1.jpg";
        ...
        <Row className='service-focus pr-3'>
            ...
            >
              ...
              <Card.Body>
                <Card.Title className='d-flex'>
                  <div className='sub-title'>Shared Whiteboard</div>
                </Card.Title>
          ...
          <Col lg={4}>
            ...
            >
              ...
              <Card.Body>
                <Card.Title className='d-flex'>
                  <div className='sub-title'>Secured File Sharing</div>
                </Card.Title>
                <Card.Text className='sub-text'>
          ...
          <Col lg={4}>
            ...
            >
              ...
              <Card.Body>
                <Card.Title className='d-flex'>
                  <div className='sub-title'>Fun Learning</div>
                </Card.Title>
                <Card.Text className='sub-text'>
