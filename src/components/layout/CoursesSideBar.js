                ...
                {filterCourseList().length?filterCourseList().map(course=>{
                    ...
                    <Link to="Tasks" spy={true } smooth={true} offset={-80} duration={500}
                      ...
                      >
                        ...
                        <div
                        className={selectedCourse== course.name? 'course-item course-item activeCourse shadow-pop-tr' :'course-item   nonActiveCourse'}
                        style={{display:'flex' , alignContent:'center'}}
                        
                      
                        onClick={()=>{setSelctedCourse(course.name)}}
                      >
                          <div     className='inner-box'>
                            <div className='image image-box  '>
                              ...
                              <a className='sub-title2 btn  w-100'>
                                {course.name}
                              </a>
