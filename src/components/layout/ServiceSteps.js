        ...
        <div class="banner">
          ...
          <div className="auto-container">
            <div className="row clearfix">
              <Row className="service-steps bg-white mt-3  no-gutters text-align-left text-center-small-screen">
                <Col
                  lg={3}
                  className="d-flex pt-3 no-letter-spacing no-gutters "
                >
                ...
                >
                  <Col lg={11} className="no-gutters">
                    ...
                    <div className="sub-text pl-3">
                      We hand-pick one of our teachers for homework help that
                      suits your personality and your goals.
                    </div>
                  </Col>
                  <div className="hide-on-small-screen">
                    <img
