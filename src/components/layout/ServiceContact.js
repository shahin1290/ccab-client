...
const ServiceContact = () => {
  ...
  const submitHandler = async ({ message, service, phone, email, code }) => {
    try {
        ...
        <div className="service-form-content">
          ...
          <Row className='mx-auto pt-4'>
                ...
                >
                  ...
                  <div class='form-group'>
                    ...
                    >
                      ...
                      <option value='4'>
                        I'm an employee and have a question
                      </option>
                    </select>
            ...
            <Col md={6} className=' mx-auto'>
              <div className='service-list p-4 mb-5'>
                <div className='sub-title pb-2'>
                  Homework help that gives results:
                </div>
                <ul>
                  <li>
                    Own certified private teacher Available in all subjects
                  </li>
