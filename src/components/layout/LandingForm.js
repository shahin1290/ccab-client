...
const Form = () => {
    ...
    const showThanksMessage=()=>{
        ...
        useEffect(() => {
            ...
            let NoError =   !ValidationError.NameErr&&
    ...
    return (
      ...
      {/* form */}
      {err ? <p className="text-danger pl-3 m-0 error-attention" style={{fontWeight:'bold'}}> {err} Error </p>:null}
      {!Hide?(
        ...
        <form className="landing-form  w-100 needs-validation p-3" onSubmit={_handelSubmit}>
                ...
                <div className="form-group mb-4 col-12" style={{position:'relative'}}>
