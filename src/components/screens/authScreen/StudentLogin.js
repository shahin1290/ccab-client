...
export default function StudentLogin({ location }) {
  ...
  const showThanksMessage=()=>{
      ...
      useEffect(() => {
          ...
          let NoError =   !ValidationError.PasswordErr&&
    ...
    <section className="student-login-section">
        {userDetail && userDetail.name ?
            ...
            <div className="student-login-box py-5 col-sm-10 col-md-6 col-lg-3 offset-md-4">
                ...
                {location.state && <span className="text-success">{location.state.message}</span>}
                {/* Title Box */}
            ...
            <form className="student-login-form w-100 needs-validation p-3" onSubmit={_handelSubmit}>
                    <>
                    <div className="form-row">
                        ...
                        Password should be at least 8 character</p> : null}
                        </div>
                    </div>
                    ...
                    <div className="form-group  col-12 sm-12">
                        ...
                        className="btn btn-warning btn-block btn-sm formButton py-1">
                            {loading?<Loader/>:<>Login <i className="mdi mdi-telegram ml-2" /></>} 
                        </button>
                    </div>

                    <div className="form-group col-lg-12 col-md-12 col-sm-12">
                            <div className="users">
                            New User ! <a href="/get-start" className="link-info text-danger" ><u>Sign up</u></a>
                            </div>
                        </div>
