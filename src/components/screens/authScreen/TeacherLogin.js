  ...
  return (
    <>
          ...
          <div className="teacher-login-box py-5 col-sm-10 col-md-6 col-lg-3 offset-1">
            ...
            <a href="layout-one-1.html"><img src="images/CF-College.png" alt='photo' className="logo-dark w-100" height={26} /></a>
              <h2 className="text-light my-5">
                Welcome Please login
                to continue!
              </h2>
            </div>
       <form className="landing-form  w-100 needs-validation p-3" onSubmit={_handelSubmit}>
                <>
