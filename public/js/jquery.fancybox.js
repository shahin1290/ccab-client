...
;(function (window, document, $, undefined) {
  ...
  var defaults = {
    ...
    btnTpl: {
      download:
        '<a download data-fancybox-download className="fancybox-button fancybox-button--download" title="{{DOWNLOAD}}">' +
...
;(function (document, $) {
  ...
  $.extend(FancyThumbs.prototype, {
    ...
    create: function () {
      ...
      self.$grid = $(
        '<div className="fancybox-thumbs fancybox-thumbs-' +
          self.opts.axis +
          '"></div>'
      ).appendTo(
      ...
      $.each(instance.group, function (i, item) {
        ...
        if (src && src.length) {
          list +=
            '<li data-index="' +
            i +
            '"  tabindex="0" className="fancybox-thumbs-loading"><img data-src="' +
            src +
            '" /></li>'
        }
      })
