    ...
    return this.each(function () {
      ...
      function _advanceInputGroup(parentelement) {
        ...
        if (prev.hasClass('input-group-btn')) {
          ...
          downhtml =
            '<span className="input-group-btn"><button className="' +
            settings.buttondown_class +
            ' bootstrap-touchspin-down" type="button">' +
            settings.buttondown_txt +
            '</button></span>'
      ...
      function _buildInputGroup() {
        ...
        if (settings.verticalbuttons) {
          html =
            '<div className="input-group bootstrap-touchspin"><span className="input-group-addon bootstrap-touchspin-prefix">' +
            settings.prefix +
            '</span><span className="input-group-addon bootstrap-touchspin-postfix">' +
            settings.postfix +
            '</span><span className="input-group-btn-vertical"><button className="' +
            settings.buttondown_class +
            ' bootstrap-touchspin-up" type="button"><i className="' +
            settings.verticalupclass +
            '"></i></button><button className="' +
            settings.buttonup_class +
            ' bootstrap-touchspin-down" type="button"><i className="' +
            settings.verticaldownclass +
            '"></i></button></span></div>'
        } else {
          html =
            '<div className="input-group bootstrap-touchspin"><span className="input-group-btn"><button className="' +
            settings.buttondown_class +
            ' bootstrap-touchspin-down" type="button">' +
            settings.buttondown_txt +
            '</button></span><span className="input-group-addon bootstrap-touchspin-prefix">' +
            settings.prefix +
            '</span><span className="input-group-addon bootstrap-touchspin-postfix">' +
            settings.postfix +
            '</span><span className="input-group-btn"><button className="' +
            settings.buttonup_class +
            ' bootstrap-touchspin-up" type="button">' +
            settings.buttonup_txt +
            '</button></span></div>'
