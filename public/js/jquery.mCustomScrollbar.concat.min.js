      ...
      v = function () {
        var t = e(this),
          ...
          l = [
            "<div id='mCSB_" +
              n.idx +
              "_scrollbar_vertical' className='mCSB_scrollTools mCSB_" +
              n.idx +
              '_scrollbar mCS-' +
              i.theme +
              ...
              "'><div id='mCSB_" +
              n.idx +
              "_dragger_vertical' className='mCSB_dragger' style='position:absolute;' oncontextmenu='return false;'><div className='mCSB_dragger_bar' /></div><div className='mCSB_draggerRail' /></div></div>",
            "<div id='mCSB_" +
              n.idx +
              "_scrollbar_horizontal' className='mCSB_scrollTools mCSB_" +
              n.idx +
              '_scrollbar mCS-' +
              i.theme +
              ...
              "'><div id='mCSB_" +
              n.idx +
              "_dragger_horizontal' className='mCSB_dragger' style='position:absolute;' oncontextmenu='return false;'><div className='mCSB_dragger_bar' /></div><div className='mCSB_draggerRail' /></div></div>"
          ],
          s =
            'yx' === i.axis
          ...
          u =
            'yx' === i.axis
              ? "<div id='mCSB_" +
                n.idx +
                "_container_wrapper' className='mCSB_container_wrapper' />"
              : '',
        ...
        i.setWidth && t.css('width', i.setWidth),
          ...
          t
            ...
            .wrapInner(
              "<div id='mCSB_" +
                n.idx +
                "' className='mCustomScrollBox mCS-" +
                i.theme +
                ' ' +
                s +
                "'><div id='mCSB_" +
                n.idx +
                "_container' className='mCSB_container' style='position:relative; top:" +
                i.setTop +
                '; left:' +
                i.setLeft +
                ";' dir=" +
      ...
      _ = function () {
        ...
        n.advanced.autoExpandHorizontalScroll &&
          ...
          i
            ...
            .wrap(
              "<div className='mCSB_h_wrapper' style='position:relative; left:0; width:999999px;' />"
            )
            .css({
              width:
