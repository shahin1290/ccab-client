      ...
      var h = function () {
        ...
        j = function () {
          ...
          e.wrap(
            '<div className="' +
              ...
              '"><div className="bx-viewport"></div></div>'
          ),
            (d.viewport = e.parent()),
            d.settings.ariaLive &&
              !d.settings.ticker &&
              d.viewport.attr('aria-live', 'polite'),
            (d.loader = a('<div className="bx-loading" />')),
            ...
            (d.controls.el = a('<div className="bx-controls" />')),
        ...
        u = function () {
          for (var b = '', c = '', e = q(), f = 0; e > f; f++)
            (c = ''),
              ...
              (b +=
                '<div className="bx-pager-item"><a href="" data-slide-index="' +
                f +
        ...
        v = function () {
          d.settings.pagerCustom
            ...
            : ((d.pagerEl = a('<div className="bx-pager" />')),
        ...
        w = function () {
          ;(d.controls.next = a(
            '<a className="bx-next" href="">' + d.settings.nextText + '</a>'
          )),
            (d.controls.prev = a(
              '<a className="bx-prev" href="">' + d.settings.prevText + '</a>'
            )),
        ...
        x = function () {
          ;(d.controls.start = a(
            '<div className="bx-controls-auto-item"><a className="bx-start" href="">' +
              d.settings.startText +
              '</a></div>'
          )),
            (d.controls.stop = a(
              '<div className="bx-controls-auto-item"><a className="bx-stop" href="">' +
                d.settings.stopText +
                '</a></div>'
            )),
            (d.controls.autoEl = a('<div className="bx-controls-auto" />')),
        ...
        y = function () {
          d.children.each(function (b) {
            ...
            void 0 !== c &&
              ('' + c).length &&
              a(this).append(
                '<div className="bx-caption"><span>' + c + '</span></div>'
              )
          })
        },
        z = function (a) {
        ...
        K = function (a) {
          var b,
            ...
            i = { left: 0, top: 0 }
          'next' === d.settings.autoDirection
            ? (h = e.find('.bx-clone').first().position())
